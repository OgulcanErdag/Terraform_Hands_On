...
- We have created an S3 bucket with versioning enabled.
...
- Now you can try to run the same command in the second terminal.
...
- Do not forget to delete ami and the snapshot from the AWS console.
